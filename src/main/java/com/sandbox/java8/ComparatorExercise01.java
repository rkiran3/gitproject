...
public class ComparatorExercise01 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(sortedPersonByName.length);
        ...
        System.out.println(sortedPersonByAgeAsc.length);
        ...
        System.out.println(sortedPersonByAgeDesc.length);
        ...
        olderThan20.forEach(System.out::println);
        System.out.println(personListFromStream.size());
    }
}
